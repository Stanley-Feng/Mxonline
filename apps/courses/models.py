...
class Course(models.Model):
    ...
    teacher_tell = models.CharField(max_length=300, default="什么都可以学到,按时交作业,不然叫家长", verbose_name=u"老师告诉你")
...
class Lesson(models.Model):
    ...
    course = models.ForeignKey(Course, on_delete=models.CASCADE, verbose_name="课程", blank=True, null=True)
